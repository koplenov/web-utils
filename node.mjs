...
var $;
(function ($) {
    class $koplenov_utils extends $mol_page {
        plugins() {
            return [];
        }
        title() {
            return "Тут соберутcя всякие хелперы по работе с текстом";
        }
        body() {
            return [
                this.Counter_block()
        ...
        Counter_block() {
            ...
            obj.title = () => this.counter_block_title();
            obj.content = () => [
                this.Input_text_in_counter_block()
            ];
            return obj;
        }
    }
    __decorate([
        $mol_mem
    ], $koplenov_utils.prototype, "Input_text_in_counter_block", null);
    __decorate([
        $mol_mem
    ], $koplenov_utils.prototype, "Counter_block", null);
    $.$koplenov_utils = $koplenov_utils;
})($ || ($ = {}));
//koplenov/utils/-view.tree/utils.view.tree.ts
;
"use strict";
var $;
(function ($) {
